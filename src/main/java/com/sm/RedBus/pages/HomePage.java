...
public class HomePage {
	...
	public SearchPage hmPageSearchBtnTest() {
...
//	
	public SearchPage navigateToSearchPage() {
		driver.findElement(from).sendKeys("kolhapur");
		driver.findElement(to).sendKeys("Pune");
		WebElement cal = driver.findElement(By.xpath("//div[@id='onwardCal']"));
		cal.click();

		driver.manage().timeouts().implicitlyWait(Duration.ofMillis(1000));
		cal.findElement(By.xpath("//span[normalize-space()='6']")).click();
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(10));
		WebElement src = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//button[@id='search_button' or @class='sc-dxgOiQ eQQkuo']")));
		src.click();
		return new SearchPage(driver);
