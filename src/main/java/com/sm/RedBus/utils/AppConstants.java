...
public class AppConstants {
	...
	public static final String SEARCH_PAGE_TITLE_VALUE ="check checkboxes clickable or not";
	public static final String LOGIN_PAGE_URL_FRACTION_VALUE = "route=account/login";
	public static final String TRAINTICKECT_PAGE_TITLE_VALUE = "redRail - Book Train Ticket, Online Train Ticket Booking App";
